...
class ComposerServiceProvider extends ServiceProvider
{
    ...
    public function boot(Factory $factory)
    {
        ...
        $factory->composer(['index', 'single-incident', 'subscribe.*', 'history', 'signup', 'dashboard.settings.theme', 'notifications::email', 'single-schedule', 'errors.*'], ThemeComposer::class);
